...
ImgTest = np.genfromtxt('/Users/inspiron/PJJOP/dataset/dataset/testtrain/testImg.csv',delimiter=',')
CatTest = np.genfromtxt('/Users/inspiron/PJJOP/dataset/dataset/testtrain/testCat.csv',delimiter=',')
ImgTrain = np.genfromtxt('/Users/inspiron/PJJOP/dataset/dataset/testtrain/trainImg.csv',delimiter=',')
CatTrain = np.genfromtxt('/Users/inspiron/PJJOP/dataset/dataset/testtrain/trainCat.csv',delimiter=',')
